...
module.exports = function (grunt) {
    ...
    grunt.initConfig({
        ...
        watch: {
            styles: {
                files: ['<%= yeoman.webapp %>/styles/{,*/}*.css'],
                    ...
                    middleware: function (connect) {
                        return [
                            ...
                            connect().use(
                                ...
                                connect.static('<%= yeoman.webapp %>/bower_components')
                            ),
